...
Recipes.create('PB and Jelly Sandwhich', "Peanut butter, jelly, bread");
Recipes.create("Pizza", "Dough, tomato sauce, cheese, pepperonni");
Recipes.create("Love", "you and me");
